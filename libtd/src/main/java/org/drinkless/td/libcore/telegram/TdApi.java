...
public class TdApi {
    ...
    public static class TdlibParameters extends Object {
         ...
         * @param systemLanguageCode IETF language tag of the user's operating system language.
         * @param deviceModel Model of the device the application is being run on.
         * @param systemVersion Version of the operating system the application is being run on.
    ...
    public static class UpdateFileGenerationStart extends Update {
         ...
         * @param conversion String specifying the conversion applied to the original file.
         */
    ...
    /**
     * Returns messages in a chat. The messages are returned in a reverse chronological order (i.e., in order of decreasing messageId). This is an offline request if onlyLocal is true.
     *
     * <p> Returns {@link Messages Messages} </p>
     */
    ...
    /**
     * Returns an ordered list of chats. Chats are sorted by the pair (order, chatId) in decreasing order. (For example, to get a list of chats from the beginning, the offsetOrder should be equal to 2^63 - 1.)
     *
    ...
    public static class ReportSupergroupSpam extends Function {
        ...
        public int userId;
        /**
         * Identifiers of messages sent in the supergroup by the user. This list should be non-empty.
         */
        public long[] messageIds;
         ...
         * @param userId User identifier.
         * @param messageIds Identifiers of messages sent in the supergroup by the user. This list should be non-empty.
         */
    ...
    /**
     * Searches for call messages. Returns the results in reverse chronological order (i. e., in order of decreasing messageId).
     *
     * <p> Returns {@link Messages Messages} </p>
     */
    ...
    /**
     * Searches for messages with given words in the chat. Returns the results in reverse chronological order, i.e. in order of decreasing messageId. Cannot be used in secret chats with a non-empty query (searchSecretMessages should be used instead), or without an enabled message database.
     *
     * <p> Returns {@link Messages Messages} </p>
     */
    ...
    /**
     * Searches for messages in all chats except secret chats. Returns the results in reverse chronological order (i.e., in order of decreasing (date, chatId, messageId)).
     *
     * <p> Returns {@link Messages Messages} </p>
     */
    ...
    public static class SearchSecretMessages extends Function {
         ...
         * @param limit Maximum number of messages to be returned; up to 100.
